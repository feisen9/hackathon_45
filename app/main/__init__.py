...
imgConf.config['ICON'] = '../hackatho_45_imgs/users_icon/'
imgConf.config['ARTICAL'] = '../hackatho_45_imgs/articals/'
imgConf.config['BOOK'] = '../hackatho_45_imgs/books/'
imgConf.config['PHOTO'] = '../hackatho_45_imgs/photos/'
